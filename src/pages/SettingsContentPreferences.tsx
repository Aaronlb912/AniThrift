...
const SettingsContentPreferences: React.FC = () => {
  ...
  const handleToggle = async () => {
    ...
    try {
      ...
      setSuccessMessage(
        newValue
          ? "18+ eBay results are now enabled for your searches."
          : "18+ eBay results will remain hidden."
      );
    } catch (err) {
    ...
    <MainLayout>
      <div className="info-page-container">
        ...
        <div className="info-content">
          <p>
            Control which marketplace results appear in your AniThrift search
            experience. Adult-only eBay listings are hidden by default to keep
            ...
            <>
              <div className="permissions-list">
                <div className="permission-item">
                  <div>
                    <h3>Show 18+ eBay Results</h3>
                    <p>
                      Allow adult-only listings from eBay to appear in your search
                      results. When disabled, these items stay hidden.
                    </p>
                  </div>
