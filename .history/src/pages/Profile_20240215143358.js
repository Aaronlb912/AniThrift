...
import ReviewsSection from "../components/ReviewSection"; // We'll create this component next
...
const Profile = () => {
  ...
  return (
    <div className="profile-container">
      ...
      <ReviewsSection reviews={userProfile.reviews} className="ReviewsSection"/>
    </div>
  );
};
