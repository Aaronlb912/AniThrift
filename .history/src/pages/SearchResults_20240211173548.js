  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        const response = await axios.get('https://api.ebay.com/commerce/catalog/v1_beta/product/232669172', {
            headers: {
