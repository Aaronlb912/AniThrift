...
const SignInPage = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // Check for error codes and set a custom error message
      if (error.code === "auth/wrong-password" || error.code === "auth/user-not-found") {
        setErrorMessage("Incorrect email or password. Please try again."); // Custom error message
      } else {
        setErrorMessage(error.message); // Display Firebase's default error message for other errors
      }
    }
  };
