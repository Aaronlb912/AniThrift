...
// import ReviewsSection from './ReviewsSection'; // We'll create this component next
  ...
  return (
    <div className="profile-container">
      ...
      <div className="selling-info">
        <div className="info-box">Active Listings: {sellingInfo.activeListings}</div>
        <div className="info-box">Sales: {sellingInfo.sales}</div>
        <div className="info-box">Account Balance: ${sellingInfo.accountBalance}</div>
      </div>
