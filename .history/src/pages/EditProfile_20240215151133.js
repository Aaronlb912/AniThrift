...
const EditProfile = () => {
  ...
  const handleUpdateProfile = async (e) => {
    ...
    if (newPassword && newPassword !== reEnteredPassword) {
      alert("Passwords do not match. Please try again."); // Use a more user-friendly way to show this message
      return;
    }
    ...
    <form onSubmit={handleUpdateProfile} className="edit-profile-form">
      ...
      <label>
        ...
        <input
          ...
          required={newPassword ? true : false} // Make it required if newPassword is not empty
        />
      </label>
