...
const Header = () => {
  ...
  return (
    ...
    <nav className="navbar">
                <Link to="/anime-videos" className="nav-link">Anime & Videos</Link>
                <Link to="/manga-novels" className="nav-link">Manga & Novels</Link>
                <Link to="/merchandise" className="nav-link">Merchandise</Link>
                <Link to="/figures-trinkets" className="nav-link">Figures & Trinkets</Link>
