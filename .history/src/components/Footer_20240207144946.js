...
const Footer = () => {
  return (
    <>
      ...
      <footerclassName="footer-layer info-links">
  ...
  <div className="social-media-section">
    ...
    <a href="https://facebook.com/yourpage"><img src="/path-to-facebook-icon.png" alt="Facebook" /></a>
    <a href="https://twitter.com/yourpage"><img src="/path-to-twitter-icon.png" alt="Twitter" /></a>
  ...
  <div className="app-store-section">
    <h2>On The Go</h2>
    <a href="https://link-to-apple-store"><img src="/path-to-apple-store-icon.png" alt="Download on the App Store" /></a>
    <a href="https://link-to-google-play-store"><img src="/path-to-google-play-icon.png" alt="Get it on Google Play" /></a>
  </div></footerclassName=>
      <legal></legal>
    </>
  );
