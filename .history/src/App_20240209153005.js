...
const App = () => {
  ...
  [{ name: 'Product 1', price: '$20' }, { name: 'Product 2', price: '$30' }] : // Picks for the user
  [{ name: 'New Product 1', price: '$15' }, { name: 'New Product 2', price: '$25' }]; // New items for non-logged-in users
