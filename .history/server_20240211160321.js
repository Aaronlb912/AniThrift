...
app.get("/auth/ebay/callback", async (req, res) => {
  ...
  const clientId = "Anithrif-Anithrif-SBX-07fc0fe97-e3f8dc2d";
  const clientSecret = process.env.EBAY_CLIENT_SECRET;
  const redirectUri = "http://localhost:3000/auth/ebay/callback"; // Must match the one registered with eBay
